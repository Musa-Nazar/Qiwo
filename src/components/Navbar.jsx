...
function Navbar() {
  const xml = (
    <header className="h-[10rem] bg-white flex items-center max-lg:h-[7rem]">
      <nav className="flex justify-between items-center w-full px-[clamp(1rem,3.263888888888889vw,4.7rem)_clamp(1rem,3.263888888888889vw,4.7rem)]">
        ...
        <div className="menu-wrap hidden max-lg:block relative w-[3rem] h-[4rem]">
          ...
          <div className="menu fixed w-full bg-[#EFEEEE] h-[calc(100vh-7rem)] left-0 bottom-0 z-[2] flex flex-col items-center invisible translate-x-[100dvw] opacity-0">
