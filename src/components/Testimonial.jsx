...
function Testimonial() {
  ...
  const xml = (
    <div className="bg-[#EFEEEE] py-[7.4rem_4.5rem] px-[1rem] max-lg:py-[4.1rem] relative">
      ...
      <div className=" w-[calc(119.4rem+4.4rem)] max-w-full mx-auto max-lg:!justify-start max-lg:w-[clamp(28.8rem,76.8vw,30.8rem)] hide-scrollbar snap-x snap-mandatory scroll-smooth max-lg:mb-0 overflow-scroll">
        <div
